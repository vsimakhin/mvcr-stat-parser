...
def deduplicate_country_names(country):
    ...
    replacements = {
        ...
        "Kongo,demokratická rep.": "Demokratická republika Kongo",
        "Konžská demokratická republika": "Demokratická republika Kongo",
        "Konžská republika": "Kongo, republika",
        "Tchaj-wan, čín.provinc": "Tchaj-wan",
        "Korea, lid. dem. rep.": "Severní Korea",
        "Korejská lidově demokratická republika": "Severní Korea",
        "Korejská republika": "Jižní Korea",
        "Írán(islámská republika)": "Írán",
        "Mnohonárodní stát Bolívie": "Bolívie",
        "Mnohonárod.stát Bolívie": "Bolívie",
        "Bolívarovská republika Venezuela": "Venezuela",
        "Bolívar. rep. Venezuela": "Venezuela",
        "Makedonie,býv.jug.rep.": "Severní Makedonie",
        "Makedonie": "Severní Makedonie",
        "Svazijsko": "Eswatini",
        "Tanzanská sjed.republik": "Tanzanie",
        "Syrská arabská rep.": "Sýrie",
        "Syrská arabská republika": "Sýrie",
        "Syrská arabská republik": "Sýrie",
        "Moldavská republika": "Moldavsko",
        "Laoská lid.dem.repub.": "Laos",
        "Brunej Darussalam": "Brunej",
        "Šrí Lanka": "Srí Lanka",
        "Velká Británie": "Spojené království",
        "Srbsko a Černá Hora": "Srbsko",
        "Svaz.rep.Jugoslávie": "Svazová republika Jugoslávie",
        "Sv. Vincenc a Grenadiny": "Svatý Vincenc a Grenadiny",
        "Česká republika": "Česká Republika",
        "Kosovo-archiv": "Kosovo",
        "Republika Kosovo": "Kosovo",
        "brit.zámořská národnost": "britské zámořské území",
        "Sv.Tomáš a Princ.ostrov": "Svatý Tomáš a Princův ostrov",
        "STP": "Svatý Tomáš a Princův ostrov",

        "neuvedený stát": "Other - Neuvedený stát",
        "nezjištěno": "Other - Neuvedený stát",
        "XXX - neuvedený nebo neznámý stát": "Other - Neuvedený stát",
        "osoba bez státní přísl.": "Other - Osoba bez státní příslušenství",
        "uprchlík dle konvence": "Other - Uprchlík dle konvence",
        "uprchlík ostatní": "Other - Uprchlík ostatní",
        "Společ.nezávisl.států": "Other - Společenství nezávislých států",
    }
